var { useState: e, useEffect: t, useRef: n, useMemo: r, useCallback: i, useContext: a, useReducer: o, useLayoutEffect: s, StrictMode: c, Suspense: l, createContext: u, createElement: d, cloneElement: f, isValidElement: p, Fragment: m, Children: h, Component: g, PureComponent: _, createRef: v, forwardRef: y, memo: b, lazy: x, startTransition: S, useTransition: C, useDeferredValue: w, useId: T, useSyncExternalStore: E, useInsertionEffect: D } = globalThis.__WWV_HOST__.React, O = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), k = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), A = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), j = (e) => {
	...
	key: "1slcih"
}]]), { WorldPlugin: I, PluginManifest: L, createSvgIconUrl: R, DEFAULT_ICON_SIZE: z } = globalThis.__WWV_HOST__.WWVPluginSDK;
//#endregion
//#region src/index.ts
function B(e) {
...
var U = class {
	constructor() {
		this.id = "wildfire", this.name = "Wildfire", this.description = "Active fire detection via NASA FIRMS (VIIRS)", this.icon = F, this.category = "natural-disaster", this.version = "1.0.0", this.context = null, this.iconUrls = {};
	}
	async initialize(e) {
		this.context = e;
	}
	...
	async fetch(e) {
		try {
			let e = this.context?.getEngineUrl() || "https://dataengine.worldwideview.dev", t = await globalThis.fetch(`${e}/api/wildfire`);
	...
	renderEntity(e) {
		let t = e.properties.frp || 0, n = B(t), r = e.properties.tier || 3, i;
		return r === 1 ? i = {
			near: 35e5,
			far: Infinity
		} : r === 2 ? i = {
			...
			near: 0,
			far: 1e6
		}), this.iconUrls[n] || (this.iconUrls[n] = R(F, { color: n })), {
			type: "billboard",
			iconUrl: this.iconUrls[n],
			color: n,
			iconScale: V(t) / 10 * (r === 1 ? 2 : r === 2 ? 1.5 : 1),
