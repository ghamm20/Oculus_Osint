...
]), { Viewer: N, Entity: P, Cartesian3: F, Cartesian2: I, Color: L, CallbackProperty: R, DistanceDisplayCondition: z, NearFarScalar: B, HeightReference: V, Resource: H, Rectangle: U, PolygonHierarchy: W, ClassificationType: ae, ArcType: G, Math: K, JulianDate: q, TimeInterval: J, TimeIntervalCollection: oe, SampledPositionProperty: se, GeoJsonDataSource: Y, PinBuilder: X, CustomDataSource: ce, ConstantProperty: le, ColorMaterialProperty: ue, Cartographic: de } = globalThis.__WWV_HOST__.Cesium, { WorldPlugin: fe, PluginManifest: pe, createSvgIconUrl: Z, DEFAULT_ICON_SIZE: me } = globalThis.__WWV_HOST__.WWVPluginSDK, Q = ({ viewer: e, enabled: r }) => {
	let i = n(null);
	return t(() => {
		if (!e || !r) {
