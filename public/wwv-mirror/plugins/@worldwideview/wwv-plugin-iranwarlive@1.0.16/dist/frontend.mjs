var { useState: e, useEffect: t, useRef: n, useMemo: r, useCallback: i, useContext: a, useReducer: o, useLayoutEffect: s, StrictMode: c, Suspense: l, createContext: u, createElement: d, cloneElement: f, isValidElement: p, Fragment: m, Children: h, Component: g, PureComponent: _, createRef: v, forwardRef: y, memo: b, lazy: x, startTransition: S, useTransition: C, useDeferredValue: w, useId: T, useSyncExternalStore: E, useInsertionEffect: D } = globalThis.__WWV_HOST__.React, O = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), k = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), A = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), j = (e) => {
...
]), { WorldPlugin: V, PluginManifest: H, createSvgIconUrl: U, DEFAULT_ICON_SIZE: W } = globalThis.__WWV_HOST__.WWVPluginSDK, G = class {
	context = null;
	iconUrls = {};
	...
	renderEntity(e) {
		...
		return this.iconUrls[a] || (this.iconUrls[a] = U(i, { color: n })), {
			type: "billboard",
...
function K(e) {
	switch (e.toLowerCase()) {
		case "missile strike": return R;
		case "air strike": return L;
		case "ground combat": return B;
		case "artillery": return I;
		default: return z;
	}
}
var q = class extends G {
	constructor(...e) {
		super(...e), this.id = "iranwarlive", this.name = "Iran War Live", this.description = "Live OSINT tracking — Data sourced from IranWarLive.com (Not for Life-Safety)", this.icon = z, this.category = "conflict", this.version = "1.0.2", this.defaultLayerColor = "#ef4444", this.clusterDistance = 40;
	}
	getSeverityValue(e) {
	...
	getEntityIcon(e) {
		return K(e.properties.type || "Unknown");
	}
