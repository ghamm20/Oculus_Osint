...
]), { Viewer: de, Entity: fe, Cartesian3: D, Cartesian2: pe, Color: O, CallbackProperty: k, DistanceDisplayCondition: A, NearFarScalar: j, HeightReference: M, Resource: N, Rectangle: P, PolygonHierarchy: F, ClassificationType: I, ArcType: L, Math: R, JulianDate: z, TimeInterval: B, TimeIntervalCollection: me, SampledPositionProperty: he, GeoJsonDataSource: ge, PinBuilder: _e, CustomDataSource: ve, ConstantProperty: ye, ColorMaterialProperty: be, Cartographic: xe } = globalThis.__WWV_HOST__.Cesium, { Entity: V, PointGraphics: Se, BillboardGraphics: Ce, CustomDataSource: we, Camera: Te, PolygonGraphics: Ee, PolylineGraphics: De, EllipseGraphics: H, LabelGraphics: Oe, ModelGraphics: ke, PathGraphics: Ae, BoxGraphics: je, GeoJsonDataSource: Me, ScreenSpaceEventHandler: Ne, ScreenSpaceEvent: Pe } = globalThis.__WWV_HOST__.Resium, { WorldPlugin: Fe, PluginManifest: Ie, createSvgIconUrl: U, DEFAULT_ICON_SIZE: W } = globalThis.__WWV_HOST__.WWVPluginSDK, G = [
	{
		id: "ukraine-russia",
...
var Q = ({ enabled: e }) => e ? /* @__PURE__ */ q(J, { children: G.map((e) => {
	...
	renderEntity(e) {
		...
		return this.iconUrls[t] || (this.iconUrls[t] = U(E, { color: t })), {
			type: "billboard",
