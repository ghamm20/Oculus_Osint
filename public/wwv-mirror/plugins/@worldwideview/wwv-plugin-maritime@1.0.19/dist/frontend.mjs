var { useState: e, useEffect: t, useRef: n, useMemo: r, useCallback: i, useContext: a, useReducer: o, useLayoutEffect: s, StrictMode: c, Suspense: l, createContext: u, createElement: d, cloneElement: f, isValidElement: p, Fragment: m, Children: h, Component: g, PureComponent: _, createRef: v, forwardRef: y, memo: b, lazy: x, startTransition: S, useTransition: C, useDeferredValue: w, useId: T, useSyncExternalStore: E, useInsertionEffect: D } = globalThis.__WWV_HOST__.React, O = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), k = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), A = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), j = (e) => {
	...
	return !1;
}, P = y(({ color: e = "currentColor", size: t = 24, strokeWidth: n = 2, absoluteStrokeWidth: r, className: i = "", children: a, iconNode: o, ...s }, c) => d("svg", {
	ref: c,
	...M,
	width: t,
	height: t,
	...
	...s
}, [...o.map(([e, t]) => d(e, t)), ...Array.isArray(a) ? a : [a]])), F = (e, t) => {
	let n = y(({ className: n, ...r }, i) => d(P, {
		ref: i,
		iconNode: t,
...
]), { WorldPlugin: R, PluginManifest: z, createSvgIconUrl: B, DEFAULT_ICON_SIZE: V } = globalThis.__WWV_HOST__.WWVPluginSDK, H = globalThis.__WWV_HOST__.useStore, U = globalThis.__WWV_HOST__.pluginManager, W = globalThis.__WWV_HOST__.jsxRuntime, G = W.jsx, K = W.jsxs;
W.Fragment;
//#endregion
...
var q = ({ pluginId: e }) => {
	let t = {
		trailDuration: "1h",
		...H((t) => t.dataConfig.pluginSettings[e]) || {}
	}, n = H((e) => e.updatePluginSettings), r = async (t) => {
		n(e, { trailDuration: t });
		let r = U.getPlugin(e);
		r && r.enabled && await U.fetchForPlugin(e, r.context.timeRange);
	};
	return /* @__PURE__ */ K("div", {
		...
		children: [
			/* @__PURE__ */ K("div", {
				...
				children: [/* @__PURE__ */ G(I, { size: 12 }), " Trail History Duration"]
			}),
			/* @__PURE__ */ K("select", {
...
function Y(e) {
	let t = e.toLowerCase();
	for (let [e, n] of Object.entries(J)) if (t.includes(e)) return n;
	return J.other;
}
var X = class {
	constructor() {
		this.id = "maritime", this.name = "Maritime", this.description = "Vessel tracking via AIS feeds", this.icon = L, this.category = "maritime", this.version = "1.0.0", this.context = null, this.iconUrls = {};
	}
	async initialize(e) {
		this.context = e;
	}
	...
	async fetch(e) {
		try {
			...
			e === "0h" && (e = "");
			let t = e ? `?lookback=${e}` : "", n = this.context?.getEngineUrl() || "https://dataengine.worldwideview.dev";
			n = n.replace(/\/$/, "");
			let r = await fetch(`${n}/api/maritime${t}`);
	...
	renderEntity(e) {
		let t = Y(e.properties.vesselType || "other");
		return this.iconUrls[t] || (this.iconUrls[t] = B(L, { color: t })), {
			type: "billboard",
	...
	getSelectionBehavior(e) {
		return !e.speed || e.speed < .1 ? null : {
			...
			trailStepSec: 60,
			trailColor: Y(e.properties.vesselType || "other"),
