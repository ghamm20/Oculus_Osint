Write-Host "[*] Setting up Oculus0Osint for Local Development..."
...
if (-not (Test-Path "../wwv-data-engine")) {
    ...
    Write-Host "Oculus0Osint will automatically stream data from the Cloud Engine." -ForegroundColor Green
    Write-Host ""
...
Write-Host ""
Write-Host "Oculus0Osint uses PostgreSQL. Choose one option:" -ForegroundColor White
Write-Host ""
